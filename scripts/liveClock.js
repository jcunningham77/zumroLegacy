...
new LiveClock('arial','1','#ffffff','#000000','','','250','','','','',-4);
...
// this is the JavaScript file that is "LiveClock" -- paste into a new JS file...as is.. //
...
var LC_Style=[
	...
	300,				// clock width
	1,					// 12(1) or 24(0) hour?
	2,					// update never(0) secondly(1) minutely(2)
...
function LC_UpdateClock(Clock){
	...
	html+=c.OpenTags;
	if(c.DisplayDate>=3){html+=LC_DaysOfWeek[day][c.Abbreviate]+', '+' '+LC_MonthsOfYear[mnth][c.Abbreviate] + ' ' +md}
	html+=' '+hrs+':'+mins;
